...
NUCLEI = [
    ...
    "sc_total_length_um", "sc_n_fragments", "n_foci", "n_spots", "is_pachytene",
]
...
# one row per detected spot (RAD-51 etc.) — SpotMAX detector. Replaces blob_log FOCI.
...
IMAGE_SUMMARY = [
    ...
    "mean_foci", "mean_spots", "total_germline_length_um", "qc_pass", "qc_flags",
]
